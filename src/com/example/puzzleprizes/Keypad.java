...
public class Keypad extends Dialog {
	...
	private void findViews() {
		...
		keys[0] = (TextView) findViewById(R.id.keypad_1);
		keys[1] = (TextView) findViewById(R.id.keypad_2);
		keys[2] = (TextView) findViewById(R.id.keypad_3);
		keys[3] = (TextView) findViewById(R.id.keypad_4);
		keys[4] = (TextView) findViewById(R.id.keypad_5);
		keys[5] = (TextView) findViewById(R.id.keypad_6);
		keys[6] = (TextView) findViewById(R.id.keypad_7);
		keys[7] = (TextView) findViewById(R.id.keypad_8);
		keys[8] = (TextView) findViewById(R.id.keypad_9);
	}

	private void setListeners() {
		for (int i = 0; i < keys.length; i++) {
			final int t = i + 1;
			keys[i].setText(game.getAlphaSub(i));
